...
export INCLUDE_DIR=/host_usr/include:${BUILD_ROOT}/third_party/ffmpeg/patched-ffmpeg-mt/libavcodec:${BUILD_ROOT}/third_party/bzip2:/opt/media/local/include:/usr/local/include:/usr/include:$ROOTFS/usr/include:${AVDIR}:${AVDIR}/..:
ls $AVDIR
ls 
...
export CXXFLAGS=${CXXFLAGS}" -I${BUILD_ROOT}/third_party/ffmpeg/patched-ffmpeg-mt/libavcodec -I${BUILD_ROOT}/third_party/bzip2 -I/usr/local/include -I/usr/include  -I/opt/medial/local/include -I${AVDIR} -I${AVDIR}/..  "
export CFLAGS=${CXXFLAGS}
#" -idirafter /usr/include -idirafter /opt/medial/local/include  "
