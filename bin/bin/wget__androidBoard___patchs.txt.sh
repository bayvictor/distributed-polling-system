...
repo init --repo-url=git://codeaurora.org/tools/repo.git -u
git://codeaurora.org/platform/manifest.git -b gingerbread_house -m M8660AAABQNLYA3136.xml
repo sync -j4
...
../../../../patches/local/bootable/bootloader/lk/*.patch
cd ../../../kernel
