...
this script is download from below url, and the description is commented out, in order
to be directly runnable in terminal: source:
http://source.android.com/source/downloading.html

"
read readline

echo "wnloading the Source Tree
Installing Repo
...
echo "    Download the Repo script and ensure it is executable:

    $ "
curl https://dl-ssl.google.com/dl/googlesource/git-repo/repo > ~/bin/repo
chmod a+x ~/bin/repo

echo "    For version 1.15, the SHA-1 checksum for repo is 8eb56d98b36d615c3efec51868e87bebe757feb1

    For version 1.16, the SHA-1 checksum for repo is f3bfa7fd2d0a44aa40579bb0242cc20df37b5e17
"
mkdir ~/src/android_victor_build
cd   ~/src/android_victor_build
...
echo "The Android source files will be located in your working directory under their project names. The initial sync operation will take an hour or more to complete. For more about repo sync and other Repo commands, see Version Control.
...
repo init -u https://android.googlesource.com/a/platform/manifest
echo "^c to break if no network issues to deal with ,go ahead with building"
...
You now have a complete local copy of the Android codebase. Continue on to building....i
