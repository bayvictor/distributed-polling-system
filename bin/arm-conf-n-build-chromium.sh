...
export GYP_DEFINES="werror= target_arch=$ARCH sysroot=$ROOTFS disable_nacl=1 linux_use_tcmalloc=0 armv7=1 arm_neon=0 arm_thumb=0 arm_fpu=vfpv3-d16 v8_use_snapshot=false"
echo $GYP_CFLAGS
